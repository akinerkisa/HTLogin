...
if __name__ == "__main__":
  ...
  parser.add_argument("-u", "--url", required=True, help="URL to inspect and test")
  ...
  parser.add_argument("-l", "--language", default='en', help="Language code for keyword detection (default: en)")
  ...
  find_and_test_login(args.url, custom_credentials, args.rate_limit, verbose_mode, language_keywords)